...
from confutatis import siteconfig, utils
...
try:
    ...
    from confutatis._threading_local import local
...
gettext.install("confutatis", siteconfig.locale_dir)
...
def setLocale(lang):
    ...
    if not _all_locale.has_key(lang):
        _all_locale[lang] = gettext.translation("confutatis", siteconfig.locale_dir, languages=[lang])
