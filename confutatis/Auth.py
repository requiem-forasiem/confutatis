...
from confutatis.Error import ConfutatisError, ConfutatisUserError
from confutatis import DataSet, Database, Log, User, utils


class AuthError(ConfutatisUserError):
    def __init__(self, arguments={}, message=_("Authentication failed"), log=Log.ERROR, log_user=None):
        ConfutatisUserError.__init__(self, None, message, log=log, log_user=log_user)
